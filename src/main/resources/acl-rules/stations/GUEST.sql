...
(
	...
	or (s.stationtype = 'ParkingStation' and s.origin in ('FAMAS', 'FBK', 'Municipality Merano', 'skidata', 'Municipality Bolzano', 'STA', 'GARDENA', 'BVG', 'SBB', 'skidata_dynamicdata', 'fuchtstechnik', 'Affluences'))
